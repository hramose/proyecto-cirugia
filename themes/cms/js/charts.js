 $(function() {
        ...
        $('.dynamicbar').sparkline('html', {width:80,height: 30,type: 'bar', barColor: 'green', width: '80'} );

        /* Use 'html' instead of an array of values to pass options 
        to a sparkline with data in the tag */
        $('.inlinebar').sparkline('html', {width:80,type: 'bar', barColor: 'red', width: '80'} );
		
		$(".pie").sparkline('html', {width:200,height: 200,type: 'pie'});
...
$(document).ready(function() {
	...
	$(function () {
		var data = [
		    ...
		    { label: "South America",  data: 23, color: "#ed7a53"},
		    { label: "Africa",  data: 15, color: "#9FC569"},
		    { label: "Australia",  data: 9, color: "#bbdce3"},
		    { label: "Europe",  data: 7, color: "#9a3b1b"},
		    { label: "Asia",  data: 5, color: "#5a8022"},
		    { label: "Antartica",  data: 3, color: "#2c7282"}
		];
