...
class FuenteContactoController extends Controller
{
	...
	{
		$model=new FuenteContacto;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['FuenteContacto']))
		{
			$model->attributes=$_POST['FuenteContacto'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('FuenteContacto');
	 ...
	 * @param FuenteContacto $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='fuente-contacto-form')
		{
