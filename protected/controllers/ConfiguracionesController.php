...
class ConfiguracionesController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				...
				'users'=>array('@'),
				//'expression'=>'Yii::app()->user->perfil == 2',				
			),
	...
	{
		$dataProvider=new CActiveDataProvider('Configuraciones');
	...
	{
		$model=new Configuraciones('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Configuraciones']))
			$model->attributes=$_GET['Configuraciones'];
	 ...
	 * @param Configuraciones $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='configuraciones-form')
		{
