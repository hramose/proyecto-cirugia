...
class PromocionesController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Promociones']))
		{
			...
			$model->fecha_inicio = Yii::app()->dateformatter->format("yyyy-MM-dd",$_POST['Promociones']['fecha_inicio']);	
			$model->fecha_fin = Yii::app()->dateformatter->format("yyyy-MM-dd",$_POST['Promociones']['fecha_fin']);	
