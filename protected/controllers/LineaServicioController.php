...
class LineaServicioController extends Controller
{
	...
	{
		$model=new LineaServicio;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['LineaServicio']))
		{
	...
	{
		$dataProvider=new CActiveDataProvider('LineaServicio');
	 ...
	 * @return LineaServicio the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=LineaServicio::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param LineaServicio $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='linea-servicio-form')
		{
