...
class MedicamentosBiologicosController extends Controller
{
	/**
	...
	{
		$model=new MedicamentosBiologicos;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['MedicamentosBiologicos']))
		{
			$model->attributes=$_POST['MedicamentosBiologicos'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('MedicamentosBiologicos');
	 ...
	 * @param MedicamentosBiologicos $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='medicamentos-biologicos-form')
		{
