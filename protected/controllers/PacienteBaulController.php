...
class PacienteBaulController extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('PacienteBaul');
	...
	{
		$model=new PacienteBaul('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['PacienteBaul']))
			$model->attributes=$_GET['PacienteBaul'];
	 ...
	 * @param PacienteBaul $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='paciente-baul-form')
		{
