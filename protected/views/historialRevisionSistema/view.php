...
$this->menu=array(
	...
	//array('label'=>'Actualizar Revisión por Sistema', 'url'=>array('update', 'id'=>$model->id)),
	//array('label'=>'Borrar HistorialRevisionSistema', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
...
<h1>Revisión por Sistema #<?php echo $model->id; ?></h1>
