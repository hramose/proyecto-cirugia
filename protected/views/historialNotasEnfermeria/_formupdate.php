...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	//'action'=>'index.php?r=historialNotasEnfermeria/update&id=$model->id',
	'htmlOptions'=>array(
		'onsubmit'=>"onEnviar()",
	   ...
	   <table class='table'>
		   <tr>
		     <td nowrap='nowrap' width='12%'>
		        <input value ='<?php echo Yii::app()->dateformatter->format('dd-MM-yyyy',$losregistros->fecha); ?>' type='text' class='input-small' autocomplete = "off" placeholder='DD/MM/AAAA' name='fecha_<?php echo $campos ?>' id='fecha_<?php echo $campos ?>' onkeyup='mascara(this,\"-\",patron,true)' maxlength='10'>
		     </td>
		     <td nowrap='nowrap' width='20%'>
		        <input value ='<?php echo $losregistros->hora; ?>' type='text' class='input-mini' placeholder='' name='hora_<?php echo $campos ?>' id='hora_<?php echo $campos ?>' maxlength='7'>
		     </td>
		     <td nowrap='nowrap'>
				 <textarea rows='6' class = 'input-xxlarge' placeholder='' name ='nota_<?php echo $campos ?>' id='nota_<?php echo $campos ?>'><?php echo $losregistros->nota; ?></textarea>
		     </td>
		     <td nowrap='nowrap'>
