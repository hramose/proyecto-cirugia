...
<div class="row">
	...
	<div class='span5'>
		...
		<input type='text' id='total' name='total' class="input-medium" readonly='readonly' value=<?php echo $model->total; ?>>
	</div>
</div>
...
<div class="row">
	<div class="span11">
		<form id="Presupuesto" name="Presupuesto" action="index.php?r=Presupuesto/actualizarPresupuesto&idPaciente=<?php echo $elPaciente;?>&id=<?php echo $model->id; ?>" method = "post" onsubmit="onEnviar()">
		   ...
		   <tr>
		     ...
		     <td nowrap='nowrap'>
		        <input type='text' class='input-mini' maxlength = 3 placeholder='Descuento' name='desc_<?php echo $campos; ?>' id='desc_<?php echo $campos; ?>' value ='<?php echo $losregistros->desc ?>'>
		     </td>
		     <td nowrap='nowrap'>
		        <input type='text' class='input-small' placeholder='V.U Descuento' name='vu_desc_<?php echo $campos; ?>' id='vu_desc_<?php echo $campos; ?>' value ='<?php echo $losregistros->vu_desc ?>'>
		     </td>
		     <td nowrap='nowrap'>
		  ...
		  <div>
			...
			<label>Vendedor:</label>
		  	<select name='vendedor_id' id='vendedor_id' class="input-xxlarge">
					...
					?>	
						<option selected value='<?php echo $el_personal->id; ?>'><?php echo $el_personal->nombreCompleto; ?></option>	
					<?php
							}
							else
							{
			...
			<input id='variable' name='variable' type="hidden" value='<?php echo $numPresupuesto;?>'/>
		  </div>
