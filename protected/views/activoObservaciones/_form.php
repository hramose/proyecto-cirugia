...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'activo_inventario_id'); ?>
		<?php echo $form->textField($model,'activo_inventario_id'); ?>
		<?php echo $form->error($model,'activo_inventario_id'); ?>
	</div>
