...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'producto-unidad-medida-form',
	...
	<div class="row">
		<?php echo $form->labelEx($model,'corto'); ?>
		<?php echo $form->textField($model,'corto',array('size'=>20,'maxlength'=>20, 'class'=>'input-mini')); ?>
		<?php echo $form->error($model,'corto'); ?>
	</div>
