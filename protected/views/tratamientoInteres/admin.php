...
$('.search-form form').submit(function(){
	$('#tratamiento-interes-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Buscar Tratamiento de Interes - <a href="#exportar" class="btn btn-warning" role="button" data-toggle="modal"><i class="icon-share-alt icon-white"></i> Exportar</a></h1>
...
<div id="exportar" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-body">
 	...
 	<form id="frmExportar" name="frmExportar" action="index.php?r=tratamientoInteres/exportar&tipo=<?php $elTipo;?>" method = "post">
  		<div class="span5">
			<label>Filtro:</label>
...
<script>
    ...
    {
        $('body').on('dblclick', '#tratamiento-interes-grid tbody tr', function(event)
        {
            var
                rowNum = $(this).index(),
                keys = $('#tratamiento-interes-grid > div.keys > span'),
