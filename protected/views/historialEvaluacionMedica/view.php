...
$this->menu=array(
	...
	//array('label'=>'Actualizar Evolución Médica', 'url'=>array('update', 'id'=>$model->id)),
	//array('label'=>'Delete HistorialEvaluacionMedica', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
...
<h1>Evolución Médica #<?php echo $model->id; ?></h1>
