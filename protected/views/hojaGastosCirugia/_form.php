...
<hr>
	...
	<div class="row">
		<div class="span4">
			...
			<?php echo $form->dropDownList($model, 'cirujano_id',CHtml::listData(Personal::model()->findAll("activo = 'SI'"),'id','nombreCompleto'), array('class'=>'input-xlarge', 'empty'=>"(Seleccione)"));?>
			<?php echo $form->error($model,'cirujano_id'); ?>
		</div>

		<div class="span4">
			<?php echo $form->labelEx($model,'ayudante_id'); ?>
			<?php echo $form->dropDownList($model, 'ayudante_id',CHtml::listData(Personal::model()->findAll("activo = 'SI'"),'id','nombreCompleto'), array('class'=>'input-xlarge', 'empty'=>"(Seleccione)"));?>
			<?php echo $form->error($model,'ayudante_id'); ?>
		</div>

		<div class="span4">
			<?php echo $form->labelEx($model,'anestesiologo_id'); ?>
			<?php echo $form->dropDownList($model, 'anestesiologo_id',CHtml::listData(Personal::model()->findAll("activo = 'SI'"),'id','nombreCompleto'), array('class'=>'input-xlarge', 'empty'=>"(Seleccione)"));?>
	...
	<div class="row">
		<div class="span4">
			...
			<?php echo $form->dropDownList($model, 'rotadora_id',CHtml::listData(Personal::model()->findAll("activo = 'SI'"),'id','nombreCompleto'), array('class'=>'input-xlarge', 'empty'=>"(Seleccione)"));?>
			<?php echo $form->error($model,'rotadora_id'); ?>
		</div>

		<div class="span4">
			<?php echo $form->labelEx($model,'instrumentadora_id'); ?>
			<?php echo $form->dropDownList($model, 'instrumentadora_id',CHtml::listData(Personal::model()->findAll("activo = 'SI'"),'id','nombreCompleto'), array('class'=>'input-xlarge', 'empty'=>"(Seleccione)"));?>
