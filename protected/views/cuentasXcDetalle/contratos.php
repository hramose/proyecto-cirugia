...
<h1>Cuentas por Cobrar por Contrato</h1>
...
<script>
    $(document).ready(function()
    {
        ...
        {
                var contratoID= $(this).find('td:nth-child(4)').text();
                
            location.href = '<?php echo Yii::app()->createUrl('contratos/view'); ?>&id=' + contratoID;
        });
    });
</script>