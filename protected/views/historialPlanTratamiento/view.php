...
$this->menu=array(
	...
	// array('label'=>'Actualizar Plan de Tratamiento', 'url'=>array('update', 'id'=>$model->id)),
	// array('label'=>'Borrar Plan de Tratamiento', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
...
<h1>Plan de Tratamiento #<?php echo $model->id; ?></h1>
...
<div class="row">
	...
	<div class="span8">
		<table class="table table-striped">
			<tr>
				<th>Lineas de Servicio</th>
				<th>Observación</th>
			</tr>
		<?php $lasLineas = HistorialPlanTratamientoDetalle::model()->findAll("historial_plan_tratamiento_id = $model->id") ?>
		<?php 
