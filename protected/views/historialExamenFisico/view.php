...
$this->menu=array(
	...
	//array('label'=>'Actualizar Examen Físico', 'url'=>array('update', 'id'=>$model->id)),
	//array('label'=>'Delete HistorialExamenFisico', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
...
?>
<h1>Examen Físico #<?php echo $model->id; ?></h1>
