...
$('.search-form form').submit(function(){
	$('#seguimiento-tema-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Buscar Tema de Seguimiento - <a href="#exportar" class="btn btn-warning" role="button" data-toggle="modal"><i class="icon-share-alt icon-white"></i> Exportar</a></h1>
...
<div id="exportar" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-body">
 	...
 	<form id="frmExportar" name="frmExportar" action="index.php?r=seguimientoTema/exportar&tipo=<?php $elTipo;?>" method = "post">
  		<div class="span12">
			<label>Filtro:</label>
