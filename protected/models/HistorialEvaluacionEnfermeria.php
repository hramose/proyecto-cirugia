...
/**
 * This is the model class for table "historial_evaluacion_enfermeria".
 *
 * The followings are the available columns in table 'historial_evaluacion_enfermeria':
 * @property integer $id
 ...
 */
class HistorialEvaluacionEnfermeria extends CActiveRecord
{
	/**
	...
	{
		return 'historial_evaluacion_enfermeria';
	}
	...
	public function rules()
	{
		...
		return array(
			//array('paciente_id, personal_id, evaluacion, fecha', 'required'),
	 ...
	 * @return HistorialEvaluacionEnfermeria the static model class
	 */
